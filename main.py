...
class MiFormulario(QtWidgets.QWidget):
    def __init__(self, parent= None):
        ...
        self.ui.boton_suma.clicked.connect(self.obtener10)
        self.ui.boton_resta.clicked.connect(self.obtener11)
        self.ui.boton_multiplicar.clicked.connect(self.obtener12)
        self.ui.boton_dividir.clicked.connect(self.obtener13)
        self.ui.boton_porcentaje.clicked.connect(self.obtener14)
        self.ui.boton_potencia.clicked.connect(self.obtener15)
        self.ui.boton_raiz.clicked.connect(self.obtener16)
        self.ui.boton_parentesis_iz.clicked.connect(self.obtener17)
        self.ui.boton_parentesis_de.clicked.connect(self.obtener18)
        self.ui.boton_igual.clicked.connect(self.obtener19)
        self.ui.boton_decimal.clicked.connect(self.obtener20)
        self.ui.boton_borrar_2.clicked.connect(self.obtener21)
